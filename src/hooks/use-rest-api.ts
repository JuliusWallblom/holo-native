...
export function useRESTQuery<T>(
  ...
  url: string,
  config?: UseQueryOptions<RESTResponse<T>, RESTError>
) {
...
export function useRESTMutation<T, TVariables>(
  axiosClient: AxiosClient,
  method: "post" | "put" | "delete",
  url: string,
  config?: UseMutationOptions<RESTResponse<T>, RESTError, TVariables>
) {
